...
$publicaciones_id=$json_data->publicaciones_id;
try {
    $query=$connection->prepare('INSERT INTO vendedores(usuario_id, publicaciones_id) VALUES(:usuario_id, :publicaciones_id)');
    $query->bindParam(':usuario_id', $usuario_id, PDO::PARAM_INT);
    $query->bindParam(':publicaciones_id', $publicaciones_id, PDO::PARAM_STR);
    $query->execute();
    ...
    $returnData['publicaciones_id']=$publicaciones_id;
    $response=new Response();
    $response->setHttpStatusCode(201);
    $response->setSuccess(true);
    $response->addMessage("Vendedor creado");
